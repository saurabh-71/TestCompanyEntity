...
namespace TestCompanyEntity.Controllers
{
    public class StatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idState,idCountry,StateName")] State state)
        {
            ...
            ViewBag.idCountry = new SelectList(db.Countries, "idCountry", "CountryName", state.idCountry);
            return View(state);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idState,idCountry,StateName")] State state)
        {
            if (ModelState.IsValid)
            {
